...
CREATE TABLE `animales` (
   `id` INT NOT NULL AUTO_INCREMENT,
   -- Agrega el auto increment con este comando extra y que no puede ser nula
...
-- Listar registro donde el id sea 1 (sólo debe regresar un registro)
SELECT *
FROM animales
WHERE id = 1;


-- Listar registro donde el estado sea triste (puede regresar más de un registro)
SELECT *
FROM animales
WHERE estado = 'triste';
